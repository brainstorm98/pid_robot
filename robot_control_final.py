...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Robot Kontrol Arayuzu"))
        self.etiket_acisal_hiz_kontrolcu.setText(_translate("MainWindow", "Acisal Hiz Kontrolcu Katsayilari"))
        self.etiket_lineer_hiz_kontrolcu.setText(_translate("MainWindow", "Lineer Hiz Kontrolcu Katsayilari"))
        self.etiket_otonom_robot.setText(_translate("MainWindow", "Otonom Robot Kontrolu"))
        self.etiket_hedeflenen_konum_gostergesi.setText(_translate("MainWindow", "Hedeflenen Konum Katsayilari"))
        self.etiket_anlik_konum_gostergesi.setText(_translate("MainWindow", "Anlik Konum Gostegesi"))
        self.etiket_hedeflenen_konum_x.setText(_translate("MainWindow", "Hedeflenen Konum X (m):"))
        self.etiket_hedeflenen_konum_y.setText(_translate("MainWindow", "Hedeflenen Konum Y (m):"))
        self.etiket_anlik_lineer_hiz.setText(_translate("MainWindow", "Lineer Hiz (m/s):"))
        self.etiket_anlik_acisal_hiz.setText(_translate("MainWindow", "Acisal Hiz (rad/s):"))
        self.etiket_anlik_hiz_gostergesi.setText(_translate("MainWindow", "Anlik Hiz Gostergesi"))
        self.etiket_Kp_acisal.setText(_translate("MainWindow", "Kp_acisal:"))
        self.etiket_Ki_acisal.setText(_translate("MainWindow", "Ki_acisal:"))
        self.etiket_Kd_acisal.setText(_translate("MainWindow", "Kd_acisal:"))
        self.buton_dur.setText(_translate("MainWindow", "Dur"))
        self.buton_ileri.setText(_translate("MainWindow", "Ileri"))
        self.buton_sol.setText(_translate("MainWindow", "Sol"))
        self.buton_geri.setText(_translate("MainWindow", "Geri"))
        self.buton_sag.setText(_translate("MainWindow", "Sag"))
        self.etiket_manuel_robot.setText(_translate("MainWindow", "Manuel Robot Kontrolu"))
        self.etiket_anlik_konum_x.setText(_translate("MainWindow", "Anlik Konum X (m):"))
        self.etiket_anlik_konum_y.setText(_translate("MainWindow", "Anlik Konum Y (m):"))
        self.buton_otonom_start.setText(_translate("MainWindow", "Otonom Surusu Baslat"))
        self.buton_otonom_stop.setText(_translate("MainWindow", "Otonom Surusu Durdur"))
        self.etiket_Kd_lineer.setText(_translate("MainWindow", "Kd_lineer:"))
        self.etiket_Kp_lineer.setText(_translate("MainWindow", "Kp_lineer:"))
        self.etiket_Ki_lineer.setText(_translate("MainWindow", "Ki_lineer:"))
        ...
        self.buton_otonom_start.clicked.connect(self.otonomsurusBasla)
        ...
        self.line_Ki_acisal.setText(str(self.Ki_acisal))
        self.line_Kd_acisal.setText(str(self.Kd_acisal))
        self.line_Kp_lineer.setText(str(self.Kp_lineer))
        self.line_Ki_lineer.setText(str(self.Ki_lineer))
    ...
    def get_Kp_Acisal(self):
        ...
        if kp_text_acisal.replace('.', '', 1).isdigit():
            ...
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz acisal Kp degeri. Lutfen gecerli bir sayi girin.')
            self.Kp_Acisal = 0.0
            self.line_Kp_acisal.setText(str(self.Kp_acisal))
    ...
    def get_Ki_Acisal(self):
        ...
        if ki_text_acisal.replace('.', '', 1).isdigit():
            self.Kp_acisal = float(ki_text_acisal)
        else:
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz acisal Ki degeri. Lutfen gecerli bir sayi girin.')
            self.Ki_Acisal = 0.0
            self.line_Ki_acisal.setText(str(self.Ki_acisal))
    ...
    def get_Kd_Acisal(self):
        ...
        if kd_text_acisal.replace('.', '', 1).isdigit():
            ...
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz acisal Kd degeri. Lutfen gecerli bir sayi girin.')
            self.Kd_Acisal = 0.0
            self.line_Kd_acisal.setText(str(self.Kd_acisal))
    ...
    def get_Kp_Lineer(self):
        ...
        if kp_text_lineer.replace('.', '', 1).isdigit():
            ...
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz lineer Kp degeri. Lutfen gecerli bir sayi girin.')
            self.Kp_lineer = 0.0
            self.line_Kp_lineer.setText(str(self.Kp_lineer))
    ...
    def get_Kd_Lineer(self):
        ...
        if kd_text_lineer.replace('.', '', 1).isdigit():
            ...
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz lineer Kd degeri. Lutfen gecerli bir sayi girin.')
            self.Kd_lineer = 0.0
            self.line_Kd_lineer.setText(str(self.Kd_lineer))
    ...
    def get_Ki_Lineer(self):
        ...
        if ki_text_lineer.replace('.', '', 1).isdigit():
            ...
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz lineer Ki degeri. Lutfen gecerli bir sayi girin.')
            self.Ki_lineer = 0.0
            self.line_Ki_lineer.setText(str(self.Ki_lineer))
    ...
    def hedef_konumX(self):
        ...
        if line_hedeflenen_konum_x_text.replace('.', '', 1).isdigit():
            ...
            QtWidgets.QMessageBox.warning(self.centralwidget, 'Hata', 'Gecersiz hedeflenen konum degeri. Lutfen bir sayi girin.')
            self.hedef_x = 0.0
            self.line_hedeflenen_konum_x.setText(str(self.hedef_x))
    ...
    def otonomsurusBasla(self,mesaj):
